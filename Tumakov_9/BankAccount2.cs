...
namespace Tumakov_9
{
    class BankAccount2
    {
        ...
        public bool Transfer_money(BankAccount2 account, decimal money)
        {
        ...
        public void Dispose(BankAccount2 bankAccount)
        {
        ...
        public BankAccount2(decimal balance, Type_bank_account bank_account)
        {
        ...
        public BankAccount2(Type_bank_account bank_account)
        {
            number_account = next_number_account;
            this.bank_account = bank_account;
            Generate_next_number_account();
